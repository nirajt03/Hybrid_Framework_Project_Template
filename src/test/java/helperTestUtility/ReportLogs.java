 ...
 */
public class ReportLogs extends ReportingUtility {

    public static final Logger logger = LogManager.getLogger(ReportLogs.class);

    private static ThreadLocal<ExtentTest> extentNode = ReportingUtility.dataProviderTest;
    private static ThreadLocal<ExtentTest> extentTest = ReportingUtility.methodTest;
